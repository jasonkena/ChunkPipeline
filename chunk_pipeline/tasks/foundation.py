...
def chunk_normalize_empty(vol, ignore_below_std):
    return chunk.chunk(_normalize_empty, [vol], output_dataset_dtypes=[vol.dtype], ignore_below_std=ignore_below_std)
...
def task_foundation_seg(cfg, h5):
    ...
    thresholded = chunk_threshold_z_score(blurred, z_score=foundation["THRESHOLD_Z_SCORE"])
